package com.li.day08_springboot_emp.config;
...
public class GlobalTransaction {
    ...
    //restful包下所有service包或者service的子包的任意类的任意方法,第一个*返回值第二个*任意类第三个*任意方法..代表：任意参数
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.rr.service.impl.*.*(..))";

    @Autowired
    private PlatformTransactionManager transactionManager;//自动创建

    @Bean//创建对象 相当于xml里的<bean id ="txAdvice">,id来自于方法名
    ...
    @Bean
    public Advisor txAdviceAdvisor() {//在aop配xml中
